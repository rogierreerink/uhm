...
$$
    BEGIN
        ...
        INSERT INTO public.ingredient_collections (id, product_id)
        ...
        INSERT INTO public.ingredients (id, product_id)
        VALUES ('9ffbf5f7-aff0-4ab2-808e-27ce896db94c', '49b6b1f9-541d-4dff-a3d5-0195cb0f6541'),
               ('914e3c07-2caa-40f8-a90a-fa91e752fbdf', '170f015f-d9ce-4f90-b461-efcbaae6891f'),
               ('599315d2-b122-4e92-97bd-a3b3fdf9844b', 'e929b8ee-c45f-4ebe-90dc-5366b4e5b36e')
        ON CONFLICT (ID) DO UPDATE
            SET product_id = EXCLUDED.product_id;
